...
## Replace dada2 by another algorithm for taxonomic assignation
...
and after the creation of the phyloseq object, add a new target with the following code to assign taxonomy with another algorithm (e.g. sintax) and database (e.g. Unite for Fungi)
