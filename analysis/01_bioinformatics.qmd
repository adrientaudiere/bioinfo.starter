...
log_data <- autometric::log_read(
  "data/data_final/autometric_log.txt",
  units_time = "hours",
...
```{r}
krona(clean_pq(d_pq, simplify_taxo =TRUE), paste0(here::here("data/data_final/"), krona_nb_seq.html"))
krona(clean_pq(d_pq, simplify_taxo =TRUE), nb_seq = FALSE, paste0(here::here("data/data_final/"), krona_nb_taxa.html"))
```
