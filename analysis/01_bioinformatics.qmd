...
```{r}
krona(clean_pq(d_pq, simplify_taxo =TRUE), "krona_unite.html", name="Unite")
krona(clean_pq(d_pq, simplify_taxo =TRUE), ranks=8:14, "krona_eukaryome.html", name="Eukaryome")
merge_krona(c("krona_unite.html", "krona_eukaryome.html"))
```

```{r}
krona(clean_pq(d_pq, simplify_taxo =TRUE), "krona_unite_taxa.html", nb_seq=FALSE, name="Unite")
krona(clean_pq(d_pq, simplify_taxo =TRUE), ranks=8:14, "krona_eukaryome_taxa.html", nb_seq=FALSE, name="Eukaryome")
merge_krona(c("krona_unite_taxa.html", "krona_eukaryome_taxa.html"), output="mergeKrona_taxa.html")
```
