...
```{r}
krona(clean_pq(d_pq, simplify_taxo =TRUE), here::here("data/data_final/krona_nb_seq.html"))
krona(clean_pq(d_pq, simplify_taxo =TRUE), nb_seq = FALSE, here::here("data/data_final/krona_nb_taxa.html"))
```
